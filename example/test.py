...
class PageOne(tk.Frame):
    ...
    def __init__(self, parent,controller):
        ...
        label7 = tk.Label(self,text="degree").grid(column=1, row=1)
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent,controller):
        ...
        label7 = tk.Label(self,text="Axis").grid(column=0, row=1)
        label8 = tk.Label(self,text="Position").grid(column=1, row=1)
